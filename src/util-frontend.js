 ...
 * @returns {Object[]} A list of the given timezones sorted by their offset from
 *     UTC.
 *
 * Generated by Trelent
 */
...
/**
 * Get the base URL
 * Mainly used for dev, because the backend and the frontend are in different
 * ports.
 * @returns {string}
 */
...
/**
 *
 * @param {} mqtt wheather or not the regex should take into account the fact
 *     that it is an mqtt uri
