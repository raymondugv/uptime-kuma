    ...
    try {
      ...
      if (notification.ntfyAuthenticationMethod === "usernamePassword") {
        headers = {
          Authorization : "Basic " + Buffer
                                         .from(notification.ntfyusername + ":" +
      ...
      if (heartbeatJSON == null) {
        let ntfyTestData = {
          ...
          title :
              (monitorJSON?.name || notification.ntfytopic) + " [Uptime-Kuma]",
          message : msg,
          priority : notification.ntfyPriority,
          tags : [ "test_tube" ],
        };
        await axios.post(`${notification.ntfyserverurl}`, ntfyTestData,
                         {headers : headers});
        return okMsg;
      }
      let tags = [];
      ...
      await axios.post(`${notification.ntfyserverurl}`, data, {
        headers : headers,
      });
